      ...
      child: Column(
        ...
        children: [
          ...
          const Padding(
            ...
            child: Text(
              'Bật camera để quét mã vạch và thêm sản phẩm vào giỏ tự động.',
      ...
      child: Column(
        ...
        children: [
          ...
          const Padding(
            ...
            child: Text(
              'Các mặt hàng quét được sẽ hiển thị tại đây khi bạn dùng camera phía trên.',
              textAlign: TextAlign.center,

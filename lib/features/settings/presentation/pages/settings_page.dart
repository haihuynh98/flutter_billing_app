        ...
        child: Column(
          children: [
            ...
            _buildListGroup(
              children: [
                _buildListItem(
                  ...
                  title: 'Sản Phẩm',
                  subtitle: 'Quản lý kho hàng và mã vạch',
                        ...
                        children: [
                          Text(
                            state.connectedMac != null
                                ? (state.connectedName ?? 'Máy in đã kết nối')
                                : 'Chưa kết nối máy in',
                            style: TextStyle(
            ...
            Padding(
              ...
              child: Text(
                "Để kết nối thiết bị mới, nhấn vào biểu tượng Cài Đặt để ghép đôi trong phần Bluetooth của điện thoại, sau đó quay lại và nhấn Làm Mới.",
                style: TextStyle(
                    fontSize: 11,

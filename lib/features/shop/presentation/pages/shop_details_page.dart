              ...
              child: Form(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    Text(
                      'Thông tin này sẽ hiển thị trên hóa đơn điện tử và hóa đơn in.',
                    ...
                    _buildTextField(
                      ...
                      hint: 'Ví dụ: Tạp hóa Minh Tâm',
                      validator: AppValidators.required('Vui lòng nhập thông tin bắt buộc'),
                    ),
                    const SizedBox(height: 15),
                    const InputLabel(text: 'Địa chỉ dòng 1'),
                    _buildTextField(
                      controller: _address1Controller,
                      hint: 'Ví dụ: 123 Đường Trần Hưng Đạo',
                      validator: AppValidators.required('Vui lòng nhập thông tin bắt buộc'),
                    ),
                    const SizedBox(height: 15),
                    const InputLabel(text: 'Địa chỉ dòng 2 (tuỳ chọn)'),
                    _buildTextField(
                      controller: _address2Controller,
                      hint: 'Phường, quận/huyện',
                    ),
                    const SizedBox(height: 15),
                    ...
                    Row(
                      ...
                      children: [
                        const InputLabel(text: 'Lời nhắn cuối hoá đơn'),

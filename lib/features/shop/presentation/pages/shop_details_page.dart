                ...
                child: Column(
                  ...
                  children: [
                    ...
                    _buildTextField(
                      ...
                      hint: 'Quận/huyện, tỉnh/thành phố',
                    ),
                    const SizedBox(height: 15),
                    ...
                    const SizedBox(height: 15),
                    const InputLabel(text: 'ID thanh toán UPI (tuỳ chọn)'),
                    _buildTextField(
                      controller: _upiController,
                      hint: 'ten@upi (dùng cho QR thanh toán Ấn Độ)',
                    ),
                    const SizedBox(height: 15),
                    Row(
                      mainAxisAlignment: MainAxisAlignment.spaceBetween,
                      children: [
                        const InputLabel(text: 'Dòng chân hóa đơn'),

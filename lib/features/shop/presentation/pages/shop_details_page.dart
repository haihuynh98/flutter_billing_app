              ...
              child: Form(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    const SizedBox(height: 15),
                    const InputLabel(text: 'Mã thanh toán (UPI/QR)'),
                    _buildTextField(
                      controller: _upiController,
                      hint: 'thanhtoan@nganhang',
                    ),
                    const SizedBox(height: 15),
                    Row(
                      mainAxisAlignment: MainAxisAlignment.spaceBetween,
                      children: [
                        const InputLabel(text: 'Chân trang hóa đơn'),
